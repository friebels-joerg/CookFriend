...
public class SampleDataProvider {
   ...
   static {
      ...
      addRecipe(new Recipe(null, "Quinoa Salmon Salad", "Salads",
      ...
      addRecipe(new Recipe(null, "Chef's Salad", "Salads",
      ...
      addRecipe(new Recipe(null, "House Salad", "Salads",
      ...
      addRecipe(new Recipe(null, "Garden Buffet", "Salads",
            "Choose from our fresh local, organically grown ingredients to make a custom salad.",
            4, 10, ""));

      addRecipe(new Recipe(null, "Mini Cheeseburgers", "Starters",
      ...
      addRecipe(new Recipe(null, "Panko Stuffed Mushrooms", "Starters",
      ...
      addRecipe(new Recipe(null, "French Onion Soup", "Starters",
      ...
      addRecipe(new Recipe(null, "Artichokes with Garlic Aeoli", "Starters",
      ...
      addRecipe(new Recipe(null, "Parmesan Deviled Eggs", "Starters",
            "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                  "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
            5, 8, "deviled_eggs.jpg"));

      addRecipe(new Recipe(null, "Classic Burger", "Entrees",
      ...
      addRecipe(new Recipe(null, "Tomato Bruschetta Tortellini", "Entrees",
      ...
      addRecipe(new Recipe(null, "Handcrafted Pizza", "Entrees",
      ...
      addRecipe(new Recipe(null, "Barbecued Tofu Skewers", "Entrees",
      ...
      addRecipe(new Recipe(null, "Fiesta Family Platter", "Entrees",
      ...
      addRecipe(new Recipe(null, "Crème Brûlée", "Desserts",
